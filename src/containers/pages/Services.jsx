...
function Services() {
  ...
  return (
    <Layout>
      <Helmet>
        <title>doWhile | Servicios</title>
        <meta
          name="description"
          content="agencia software, marketing, web, creacion paginas, create web"
        />
        <meta name="keywords" content="agencia software, marketing, web, creacion paginas, create web" />
        ...
        <meta property="og:url" content="https://www.dowhile.pro/servicios" />
      ...
      <div className="pt-28">
        ...
        <ServicesList posts={posts_software} section_title={'Desarrollo y producción de Software'} />
      </div>
      <Footer />
    </Layout>
  )
