...
const solutions = [
    ...
    {
        name: 'Servicios',
        description: 'Sed blandit libero volutpat',
        href: '/servicios',
        icon: IconTwo,
    },
    {
        name: 'Nosotros',
        description: 'Orci porta non pulvinar neque',
        href: '/nosotros',
        icon: IconThree,
    },
    {
        name: 'Carreras',
        description: 'Vestibulum lorem sed risus',
        href: '/carreras',
        icon: IconOne,
    },
    {
        name: 'Blog',
        description: 'Molestie ac feugiat sed lectus',
        href: '/blog',
        icon: IconTwo,
    },
    {
        name: 'Contacto',
        description: 'Nulla porttitor massa',
        href: '/contacto',
        icon: IconThree,
    },
]
...
function Navbar() {
    ...
    return (
        <nav id="navbar" className="w-full py-4 top-0 bg-white transition duration-300 ease-in-out z-40 fixed ">
            <div className=" bg-white px-4 sm:px-6">
                <div className="-ml-4 -mt-2 hidden lg:flex flex-wrap items-center justify-between sm:flex-nowrap px-2 md:px-4">
                    <Link to='/' className="ml-4 mt-5">
                        <img
                            src={logo}
                            width={150}
                            height={120}
                    ...
                    <div className="ml-4 mt-2 flex-shrink-0">
                        ...
                        <Link
                            to="/nosotros"
                            className="inline-flex ml-8 items-center rounded-md border border-transparent bg-orange-button px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-gray-900 transition duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2"
                        >
                            Hire Us
                            <DotLoader className="ml-3 -mr-1 h-5 w-5" loading={loading} size={20} color="#f2f2f2" />                        </Link>
                    </div>
                </div>
                <div className="-ml-4 -mt-2 lg:hidden flex items-center justify-between sm:flex-nowrap px-2 md:px-14 ">
