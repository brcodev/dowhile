        ...
        <div class="relative p-4 bg-white dark:bg-gray-800">
            <div class="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-12 lg:items-center">
                        ...
                        <li>
                            <div class="flex">
                                <div class="flex-shrink-0">
                                    <div class="flex items-center justify-center w-12 h-12 text-white bg-orange-button rounded-md">
                ...
                <div class="relative mt-10 -mx-4 md:-mx-12 lg:mt-0 lg:col-start-1">
                    <img src="https://images.pexels.com/photos/6476260/pexels-photo-6476260.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="illustration" class="relative w-auto mx-auto rounded shadow-lg" />
                </div>
            </div>
        </div>
